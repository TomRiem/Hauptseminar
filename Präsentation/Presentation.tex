...
\begin{frame}{Symmetric Rank One Update}
    Let $\nu \in (0,1)$, $\mathcal{H}^{SR1}_0 [\cdot] = id_{\tangent{x_0}}[\cdot]$. We have
    \begin{align*}
    ...
    \begin{table}[H]
        \resizebox{\textwidth}{!}{
            \begin{tabular}{lcccccc}
                ...
                $\varnothing$ k Allocations& $9.2$ & $41.5$ & $10.2$ & $70.1$ & $10.5$ & $83.1$ \\
                \bottomrule
            \end{tabular}
        }
    \end{table}
...
\begin{frame}{Conclusion}
    \begin{itemize}
        ...
        \item Next step: Implementing limited-memory variant (and other approximation methods).
    \end{itemize}
    \vspace{10mm}
    \begin{center}
...
\begin{frame}{References}
    ...
    Absil, P.-A. and Mahony, R. and Sepulchre, R.: Optimization Algorithms on Matrix Manifolds, 2008. \\[0.7\baselineskip]
    \textbf{[Huang, 2013]}: \\
    Huang, W.: Optimization Algorithms on Riemannian Manifolds with Applications, 2013. \\[0.7\baselineskip]
    Huang, W. and Absil, P.-A. and Gallivan, K. A.: A Riemannian symmetric rank-one trust-region method, 2014. \\[0.7\baselineskip]
    Absil, P.-A. and Baker, C. G. and Gallivan, K. A.: Trust-region methods on Riemannian manifolds, 2007. \\[0.7\baselineskip]
\end{frame}
